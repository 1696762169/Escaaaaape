...
public class EventMgr : SingletonBase<EventMgr>
{
    ...
    {
        if (events.ContainsKey(eventName) && (events[eventName] as EventInfo<T>).actions != null)
        {
    ...
    {
        if (events.ContainsKey(eventName) && (events[eventName] as EventInfo).actions != null)
        {
